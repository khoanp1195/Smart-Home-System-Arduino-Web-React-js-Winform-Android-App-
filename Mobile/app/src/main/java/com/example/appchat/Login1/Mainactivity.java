package com.example.appchat.Login1;
...
import com.example.appchat.ControlDevice;
import com.example.appchat.MainDishplay.hienthi3;
import com.example.appchat.Manual;
import com.example.appchat.PrivacyPolicyActivity;
import com.example.appchat.R;
import com.example.appchat.Sanh;
import com.example.appchat.admin;
import com.example.appchat.chart;
import com.example.appchat.MainDishplay.display;
import com.example.appchat.layout1;
import com.example.appchat.reportissue.ReportProblemActivity;
import com.example.appchat.tip;
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()){
            ...
            case R.id.nav_profile:
                Intent intent12 = new Intent(Mainactivity.this, Profile.class);
            ...
            case R.id.nav_support:
                Intent support = new Intent(Mainactivity.this, ChatBotActivity.class);
                startActivity(support);
                break;
            case R.id.nav_video:
                Intent video = new Intent(Mainactivity.this, Manual.class);
                startActivity(video);
                break;
            case R.id.privacy:
            ...
            case R.id.nav_control:
                Intent control = new Intent(Mainactivity.this, hienthi3.class);
                startActivity(control);
                break;
            case R.id.nav_faq:
                Intent faq = new Intent(Mainactivity.this, com.example.appchat.faq.FaqActivity.class);
                startActivity(faq);
                break;
            case R.id.nav_logout:
                Intent intent1 = new Intent(Mainactivity.this, Sanh.class);
                ...
                builder.setPositiveButton("Có", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Intent intent =  new Intent(Mainactivity.this,Sanh.class);
